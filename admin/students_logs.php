...
$general_page_title  = 'Student Activity Log';
...
<body>
                        ...
                        <div class="col-12">
                            <div class="card log-card">
                                <div class="card-header text-white fw-semibold d-flex align-items-center justify-content-between flex-wrap" style="background-color: #2563EB; font-size: large;">
                                    <div>
                                        <i class="bi bi-person-workspace"></i>&ensp;Student Activity Log
                                    </div>
                                </div>
                                <div class="card-body mt-3 bg-white">
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            <label for="student-date-range" class="mb-0">Date range:</label>
                                            <input type="text" id="student-date-range" class="form-control form-control-sm" data-toggle="date-picker-range" />
                                            <button type="button" id="student-clear-date" class="btn btn-outline-secondary btn-sm">Clear</button>
                                        </div>
                                        <div id="student-log-summary" class="small text-muted"></div>
                                    </div>
    ...
    <script>
        window.studentLogsConfig = {
            baseUrl: '<?php echo BASE_URL; ?>',
        };
    </script>
    <script src="<?php echo BASE_URL; ?>admin/js/student_logs.js?v=<?php echo FILE_VERSION; ?>"></script>
</body>
