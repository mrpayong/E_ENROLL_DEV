document.addEventListener('DOMContentLoaded', function () {
    if (!window.deanUploadsConfig || !Array.isArray(window.deanUploadsConfig.tableData)) {
        return;
    }

    const tableElement = document.getElementById('dean-uploads-table');
    if (!tableElement || typeof Tabulator === 'undefined') {
        return;
    }

    const tableData = window.deanUploadsConfig.tableData;
    ...
    new Tabulator(tableElement, {
        ...
        placeholder: 'No dean uploads found.',
