document.addEventListener('DOMContentLoaded', function () {
    if (!window.studentLogsConfig) {
        return;
    }

    const tableElement = document.getElementById('student-log-table');
    if (!tableElement || typeof Tabulator === 'undefined') {
        return;
    }

    const baseUrl = window.studentLogsConfig.baseUrl || '';
    const summaryElement = document.getElementById('student-log-summary');
    const dateRangeInput = document.getElementById('student-date-range');
    const clearBtn = document.getElementById('student-clear-date');
    ...
    const table = new Tabulator(tableElement, {
        ...
        ajaxParams: { table: 'activity_log', role: 'student' },
        ...
        ajaxLoader: true,
        ajaxLoaderLoading: 'Loading student activity logs...',
    ...
    function reloadWithDateFilter(range) {
        const params = { table: 'activity_log', role: 'student' };
