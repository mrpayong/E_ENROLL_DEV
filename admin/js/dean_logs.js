document.addEventListener('DOMContentLoaded', function () {
    if (!window.deanLogsConfig) {
        return;
    }

    const tableElement = document.getElementById('dean-log-table');
    if (!tableElement || typeof Tabulator === 'undefined') {
        return;
    }

    const baseUrl = window.deanLogsConfig.baseUrl || '';
    const summaryElement = document.getElementById('dean-log-summary');
    const dateRangeInput = document.getElementById('dean-date-range');
    const clearBtn = document.getElementById('dean-clear-date');
    ...
    const table = new Tabulator(tableElement, {
        ...
        ajaxParams: { table: 'activity_log', role: 'dean' },
        ...
        ajaxLoader: true,
        ajaxLoaderLoading: 'Loading dean activity logs...',
    ...
    function reloadWithDateFilter(range) {
        const params = { table: 'activity_log', role: 'dean' };
