document.addEventListener('DOMContentLoaded', function () {
    if (!window.registrarUploadsConfig || !Array.isArray(window.registrarUploadsConfig.tableData)) {
        return;
    }

    const tableElement = document.getElementById('registrar-uploads-table');
    if (!tableElement || typeof Tabulator === 'undefined') {
        return;
    }

    const tableData = window.registrarUploadsConfig.tableData;
    ...
    new Tabulator(tableElement, {
        ...
        placeholder: 'No registrar uploads found.',
