...
$general_page_title  = 'Admin Activity Log';
...
<body>
                        ...
                        <div class="col-12">
                            <div class="card log-card">
                                <div class="card-header text-white fw-semibold d-flex align-items-center justify-content-between flex-wrap" style="background-color: #2563EB; font-size: large;">
                                    <div>
                                        <i class="bi bi-person-workspace"></i>&ensp;Admin Activity Log
                                    </div>
                                </div>
                                <div class="card-body mt-3 bg-white">
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            <label for="admin-date-range" class="mb-0">Date range:</label>
                                            <input type="text" id="admin-date-range" class="form-control form-control-sm" data-toggle="date-picker-range" />
                                            <button type="button" id="admin-clear-date" class="btn btn-outline-secondary btn-sm">Clear</button>
                                        </div>
                                        <div id="admin-log-summary" class="small text-muted"></div>
                                    </div>
                                    <div id="admin-log-table"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo BASE_URL; ?>admin/js/admin_logs.js?v=<?php echo FILE_VERSION; ?>"></script>
</body>
