                ...
                try {
                    ...
                    if ($query_student) {
                        ...
                        if ($count_student > 0) {
                            ...
                            $insert_into = "INSERT INTO final_grade (student_id,student_name,student_id_text,section_name,subject_code,course_desc,program_code,major,units,final_grade,final_grade_text,converted_grade,school_year_id,school_year,sem,remarks,yr_level,school_name,date_added,status,credit_code) VALUES ('" . escape($db_connect, $student_id) . "','" . escape($db_connect, $column['STUDENT NAME']) . "','" . escape($db_connect, $column['STUDENT ID']) . "','" . escape($db_connect, $column['SECTION']) . "','" . escape($db_connect, $column['COURSE']) . "','" . escape($db_connect, $column['COURSE DESCRIPTION']) . "','" . escape($db_connect, $column['PROGRAM']) . "','" . escape($db_connect, $column['MAJOR']) . "','" . escape($db_connect, $column['UNITS']) . "','" . $final_grade_insert . "','" . $final_grade_text . "','" . escape($db_connect, $column['RATING']) . "','0','" . escape($db_connect, $column['FISCAL YEAR']) . "','" . escape($db_connect, $column['SEM']) . "','" . escape($db_connect, $column['REMARKS']) . "','" . escape($db_connect, $column['YEAR LEVEL']) . "','" . escape($db_connect, $column['SCHOOL NAME']) . "','" . escape($db_connect, DATE_NOW . " " . TIME_NOW) . "','1', '" . escape($db_connect, $column['CREDIT CODE']) . "')";
